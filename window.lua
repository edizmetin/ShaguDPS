...
local function CreateBar(parent, i, background)
  -- Create or retrieve the StatusBar for the current index
  ...
  parent.bars[i]:SetPoint("TOPRIGHT", parent, "TOPRIGHT", -2, -config.height * (i-1) - 20)
  
  -- Set the bar height and frame level
  parent.bars[i]:SetHeight(config.height - config.spacing)
  parent.bars[i]:SetFrameLevel(4)
  
  -- Create or retrieve the background texture
  ...
  parent.bars[i].background:SetAllPoints(parent.bars[i])
  ...
  parent.bars[i].textLeft:SetFont(STANDARD_TEXT_FONT, 10)
  ...
  parent.bars[i].textLeft:SetPoint("TOPLEFT", parent.bars[i], "TOPLEFT", -5, 20)
  ...
  parent.bars[i].textRight:SetFont(STANDARD_TEXT_FONT, 10)
  ...
  parent.bars[i].textRight:SetPoint("TOPLEFT", parent.bars[i], "TOPLEFT", 5, 20)
